  ...
  <div id="app">
    <div class="content">
      ...
      <div class="background-container">
        <video class="background-video" autoplay loop muted playsinline src="../public/268528_medium.mp4">
...
#app {
  position: relative;
  /* Wichtig als Positionierungskontext */
}
...
.background-video {
  ...
  height: 100%;
  object-fit: cover;
  /* Stellt sicher, dass das Video den gesamten Bereich füllt, ohne das Seitenverhältnis zu verzerren */
}
...
.overlay {
  ...
  /* Entspricht in etwa bg-gray-900 mit 60% Opazität */
  z-index: -1;
  /* Liegt über dem Video, aber unter dem Inhalt */
}
...
.main-content {
  ...
  margin: 0 auto;
  height: 100vh;
  /* Nimmt die volle Höhe des Viewports ein */
}
...
.app-header {
  ...
  text-align: center;
  color: white;
  /* Header-Text jetzt weiß für besseren Kontrast */
}
...
.board-widget {
  ...
  /* Etwas stärkerer Schatten für den Kontrast */
  color: #f9fafb;
  /* Hellerer Text für die Widgets */
}
