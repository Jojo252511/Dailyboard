...
// --- Lifecycle Hooks ---
onMounted(() => {
    // Optional: Wetter für die Standardstadt beim Laden abrufen
    // Wenn city.value leer ist, wird nichts passieren, bis der Nutzer eine Eingabe macht.
    // Wenn du immer eine Meldung beim Start willst (z.B. "Bitte Stadt eingeben"),
    // kannst du userMessage hier initial setzen.
...
.weather-placeholder {
    ...
    color: #6b7280;
    margin-top: 1rem;
    padding: 0.5rem; /* Etwas Padding, damit es nicht so gequetscht aussieht */
}
